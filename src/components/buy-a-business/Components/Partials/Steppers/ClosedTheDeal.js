    ...
    <div>
      <div className='understand-bg buyer-bg py-3'>
        <div className='container'>
          <h5 className='text-start seller-learning-heading lead text-white'>
            Buyer Learning Center
          </h5>
          <h3 className='text-start main-stepper-heading text-white'>Step 5: Close the Deal</h3>
        </div>
      </div>
      <div className='container'>
          ...
          <div className='col-lg-4 col-md-6 tools-column mt-lg-17'>
            <div className='row g-4'>
              <Box sx={{maxWidth: 400}}>
                ...
                <Stepper activeStep={activeStep} orientation='vertical'>
                  {steps?.map((step, index) => (
                    <Step key={step.label}>
                      <StepLabel
                        optional={index === 4 ? <Typography variant='caption'></Typography> : null}
                        className='text-primary border-bottom'
                      >
                        <Link to={step.link} className='text-primary bizOwner-stepper-text'>
                          {step.label}
                        </Link>
                      </StepLabel>
                    </Step>
              ...
              <div className='col-12'>
                <h3 className='text-start fs-2 fw-light border-bottom bizOwner-paddingy'>
                  Tools for Buyers
                </h3>
