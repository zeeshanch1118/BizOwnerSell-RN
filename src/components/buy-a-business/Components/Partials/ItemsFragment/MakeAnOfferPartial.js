  ...
  return (
    ...
    <div className="row gy-2 gx-4 recent-insights-row">
      <div className="col-lg-8 col-md-12">
        ...
        <Link to='/stepper/valuing-a-small-business-determining-its-earning-potential' className='text-decoration-none'>
          <div className="row g-0">
      ...
      <div className="col-lg-8 col-md-12">
        <div className="card bizOwner-padding">
        <Link to='/stepper/6-rules-of-thumb-for-business-valuation' className='text-decoration-none'>
          <div className="row g-0">
            <div className="col-lg-5 col-sm-12 col-md-5 closed-img">
              {/* <img src={closedBusiness} className="img-fluid rounded-start closed-img" alt="..."/> */}
              <p className="card-text text-start">
      ...
      <div className="col-lg-8 col-md-12">
        <div className="card bizOwner-padding">
        <Link to='/stepper/how-to-make-an-offer-when-purchasing-a-business' className='text-decoration-none'>
          <div className="row g-0">
            <div className="col-lg-5 col-sm-12 col-md-5 closed-img">
              {/* <img src={closedBusiness} className="img-fluid rounded-start closed-img" alt="..."/> */}
              <p className="card-text text-start">
...
export default MakeAnOfferPartial
