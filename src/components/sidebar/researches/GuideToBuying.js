    ...
    <>
      <div className='container px-5'>
        <div className='row ps-10 '>
          <h3 className=' d-inline fs-1 fw-normal pb-4'>
          ...
          <div className='col-5'>
            <span className='fw-normal'>Author:</span>
            <span className='fw-bold'> Barbara Findlay Schenck</span>
            ...
            <span className=' h-6 d-block text-muted my-2 '>Registration required.</span>
            <span className='text-muted '>
              By downloading, you agree to our <Link to={'#'}> privacy notice.</Link>
            </span>
          </div>
          <div className='col-10 my-5 '>
            <h4 className='fs-1 fw-light'>Book Description</h4>
            <p className='fs-5'>
            ...
            <h5 className='my-5 fs-1 fw-light'>This 150-page digital book provides</h5>
            <ul className='fs-5'>
            ...
            <h4 className='my-5 fs-1 fw-normal'>Reader Review</h4>
            <p className='fs-5'>
              "I am grateful to BizOwnerSell for providing this kind of information on their site --
              a small business owner like myself really needed this objective, unbiased, unemotional
              'primer'." –Patricia F. Hoffman, Health Club Owner
            </p>
            <div className=' col-3 my-5'>
              <h4 className='fs-1 fw-normal'>About the Author</h4>
              <img
                className='img-fluid'
          ...
          <div className='my-5 col-8'>
            <h4 className='fs-1 fw-normal'>About BizOwnerSell</h4>
            <p className='fs-5'>
          ...
          <div>
            <button className='btn btn-primary'>Download Guide to selling</button>
          </div>
