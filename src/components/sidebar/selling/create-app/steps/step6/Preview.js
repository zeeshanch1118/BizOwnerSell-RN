...
const Preview = (props) => {
  ...
  const uploadListings = async (e) => {
    ...
    try {
      ...
      setIsContinue(true)
      const result = await finalUploadStep(selectedFBizID, previewData?.finance, accessToken)
      if (result.status == true) {
        setIsContinue(false)
      ...
      {!loaderScreen ? (
        <div className='container'>
              ...
              <div className='carousel-inner inner-screen-carousel '>
                {previewData?.slider_images?.length > 0
                  ? previewData?.slider_images?.map((item, ind) => (
                      <div
                        className={`carousel-item h-100  ${ind == 0 ? 'active' : ''} `}
                        key={ind}
                      >
                        <img
          ...
          <div className='row mt-3 px-md-10 pt-3  '>
            ...
            {/* <div className='ps-md-10 col-md-3'>
              <h5 className='my-auto business-preview-table'>Rent:</h5>
            </div>
            <div className='mt-3 col-md-3 mt-md-0'>
              <h6 className='biz-owner-detail-price-preview my-auto'>
                <span className='mx-md-2 business-preview-table'>
                  {' '}
                  {previewData?.business_meta?.rent ?? 'NaN'}
                </span>
              </h6>
            </div> */}
          </div>
            ...
            <div className='card biz-owner-decription-preview '>
              ...
              <div className='py-3 px-0'>
                <div className='row'>
                  ...
                  {/* {previewData?.business_meta?.ffe != null &&
                  previewData?.business_meta?.ffe != undefined &&
                  previewData?.business_meta?.ffe != 'null' ? (
                    <>
                      <div className='col-md-4  my-3 biz-owner-detail-para-heading-preview '>
                  ...
                  {/* <div className='col-md-3 col-5 my-3 biz-owner-detail-para-heading-preview '>
                  Building SF:{' '}
                </div>
                <div className='col-md-9 col-7 my-3 biz-owner-paragraph'>2,500 </div> */}
                  {/* <div className='col-md-3 col-5 my-3 biz-owner-detail-para-heading-preview '>
                  Lease Expendion:{' '}
                </div>
                <div className='col-9 my-3 biz-owner-paragraph'>9/31/2030 </div> */}
                  {/* <div className='col-md-3 col-5 my-3 biz-owner-detail-para-heading-preview '> Employ: </div>
                <div className='col-md-9 col-7 my-3 biz-owner-paragraph'>5 </div> */}
                  {/* <div className='col-md-3 my-3 biz-owner-detail-para-heading-preview '>
                  {' '}
                  Furniture, Fixtures, &Equipments (FF&E):{' '}
                </div>
                <div className='col-md-9 my-md-3 biz-owner-paragraph'>
                  {' '}
                  Included in asking price{' '}
                </div> */}
                  {/* <div className='col-md-3 my-3 biz-owner-detail-para-heading-preview '> Facilities: </div>
                <div className='col-md-9 my-md-3 biz-owner-paragraph'>
                  See appendix for list of assets included in sale (valuing over 100K) which include
                  but are not limited to chandeliers, lights, and dance floors.
                </div> */}
                  {/* <div className='col-md-3 my-3 biz-owner-detail-para-heading-preview '>Competition: </div>
                <div className='col-md-9 my-md-3 biz-owner-paragraph'>
                  GLP is the only Lighting company to successfully traverse through all types of
                  venues needing production lighting. The forecasted increase in the Lighting
                  industry is due to the onslaught of weddings after the Covid-19 pandemic. Analysts
                  anticipate upwards of 2.6 million weddings to take place in 2022, up from 2.2
                  million in 2019. There are 2 other major competitors in the Production lighting
                  space; one of which is primarily DJ company but expanding into production
                  lighting.{' '}
                </div> */}
                  {/* <div className='col-md-3 my-3 biz-owner-detail-para-heading-preview '>
                  Growth & Expension:{' '}
                ...
                <div className='col-md-9 my-md-3 biz-owner-paragraph'>
                  GLP currently does about 20% of its revenue in the non-wedding event space
                  (corporate events, dance competitions, fashion shows, etc.) with several repeat
                  clients and annual events, but there is still room for further expansion in this
                  space.
                </div> */}
                  {/* <div className='col-3 my-3 biz-owner-detail-para-heading-preview '>Financing:</div>
                <div className='col-9 my-3 biz-owner-paragraph'>No Seller Financing Offered</div> */}
                  {/* <div className='col-md-3 my-3 biz-owner-detail-para-heading-preview '>
                  Support & Training:
                </div>
                <div className='col-md-9 my-md-3 biz-owner-paragraph'>
                  The seller agrees to support an onboarding period depending on the type of buyer
                  and amount of experience in the event industry.
                </div> */}
                  {/* <div className='col-md-3 my-3 biz-owner-detail-para-heading-preview '>
                  Reason for Selling:
                </div>
                <div className='col-md-9 my-md-3 biz-owner-paragraph'>
                  Need more time with Family on weekends (wedding industry usually has weekends bo
                </div> */}
                  {/* <div className='col-md-3 my-3 biz-owner-detail-para-heading-preview '>
                  Business Website:
                </div> */}
                  {/* <div className='col-md-9 my-md-3 '>
                  <Link to='https://ghabaresturant.com '>https://ghabaresturant.com </Link>
                </div> */}
                </div>
              </div>
            </div>
