...
const PrepareForExit = () => {
  const [SellerActiveStep, setSellerActiveStep] = useState(0);

  return (
    <div>
      <div className="understand-bg buyer-bg">
        <div className="container">
          <h5 className="text-start lead seller-learning-heading text-white">Seller Learning Center</h5>
