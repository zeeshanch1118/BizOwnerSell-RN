      ...
      <form className='form d-flex flex-center'>
        <div className='card-body mw-800px py-20'>
          ...
          <div className='row'>
            <label className='col-xl-3'></label>
            <div className='col-lg-9 col-xl-6'>
              <h5 className='fw-bold mb-6'>Updates From Description:</h5>
            </div>
          </div>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  type='checkbox'
                  id='kt_checkbox_7'
                  checked={data.updatesFromDescription.newsAboutKTProducts}
                  onChange={() =>
                    updateData({
                      updatesFromDescription: {
                        ...data.updatesFromDescription,
                        newsAboutKTProducts: !data.updatesFromDescription.newsAboutKTProducts,
                      },
                    })
                  }
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='kt_checkbox_7'>
                  News about Description products and feature updates
                </label>
              </div>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  type='checkbox'
                  id='kt_checkbox_8'
                  checked={data.updatesFromDescription.tipsOnGettingMore}
                  onChange={() =>
                    updateData({
                      updatesFromDescription: {
                        ...data.updatesFromDescription,
                        tipsOnGettingMore: !data.updatesFromDescription.tipsOnGettingMore,
                      },
                    })
                  }
                />
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  type='checkbox'
                  id='kt_checkbox_9'
                  checked={data.updatesFromDescription.thingsYouMissed}
                  onChange={() =>
                    updateData({
                      updatesFromDescription: {
                        ...data.updatesFromDescription,
                        tipsOnGettingMore: !data.updatesFromDescription.thingsYouMissed,
                      },
                    })
                  }
                />
              ...
              <div className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  type='checkbox'
                  id='kt_checkbox_10'
                  checked={data.updatesFromDescription.newsAboutKTPartners}
                  onChange={() =>
                    updateData({
                      updatesFromDescription: {
                        ...data.updatesFromDescription,
                        newsAboutKTPartners: !data.updatesFromDescription.newsAboutKTPartners,
                      },
                    })
                  }
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='kt_checkbox_10'>
                  News about Description on partner products and other services
                </label>
              </div>
            </div>
          </div>
