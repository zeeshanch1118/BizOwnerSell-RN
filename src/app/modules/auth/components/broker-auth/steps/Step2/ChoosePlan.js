...
import {getBrokerPackage} from '../../../../../../../components/services/broker-services/Index'
...
const ChoosePlan = (props) => {
  ...
  const getPackageListing = async () => {
    try {
      ...
      console.log('allplans', result)
      if (result.status === true) {
        setAllplans(result.package)
        setIsContinue(true)
      }
    } catch (err) {
      console.log('getPackageListing err', err)
    }
  }
    ...
    <>
      {isContinue ? (
        <div className='container  mt-10'>
          <div className='row py-5  px-md-15 mx-auto biz_owner_price_plan_section'>
            <div className='col-md-8 px-2'>
              <h1 className='biz-owner-selected-plan'>
                Please choose plan for profile subscription
              </h1>
            </div>
          </div>
          <div className=''>
            <div className='row px-5 d-flex justify-content-center'>
              ...
              {allplans?.map((item, index) => (
                <>
                  {item?.package_for == 'broker' && (
                    <div
                      className='biz_owner_Plan_card choose_plane_card  mx-1 pb-5  mb-3  col-4 mt-8'
                      key={index}
                      style={{
            ...
            {planValidation ? (
              <div className='text-danger mt-3 col-10 text-center fs-4 mx-auto'>
          ...
          <div className='col-md-11 mx-auto d-flex justify-content-end my-10'>
            {isContinueBtn == true ? (
