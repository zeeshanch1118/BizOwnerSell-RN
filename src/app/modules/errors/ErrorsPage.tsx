      ...
      >
        ...
        <div className='d-flex flex-center flex-column-auto p-10'>
          <div className='d-flex align-items-center fw-bold fs-6'>
            <a href='https://Description.com' className='text-muted text-hover-primary px-2'>
              About
            </a>
            <a href='mailto:Webicosoft@gmail.com' className='text-muted text-hover-primary px-2'>
              Contact
            </a>
