...
// import InnerScreen from '../../components/buy-a-business/searchBusinesses/innerScreen/InnerScreen'
// import BusinessScreen from '../../components/buy-a-business/searchBusinesses/BusinessScreen'
...
const PublicRoutes = () => {
  ...
  // const BusinessCategories = lazy(() => import('../../components/buy-a-business/businessDetails/BusinessCategories'))
  ...
  const BrokerRegistration = lazy(
    () => import('../modules/auth/components/broker-auth/steps/BrokerRegistration')
  )
  return (
    <Routes>
      <Route element={<PublicLayout />}>
        ...
        <Route path='auth/registration/broker' element={<BrokerRegistration />} />
        <Route
          path=''
          element={
            <SuspensedView>
